...
const Layout = ({onLogout, user}) => {
 ...
 const fetchTasks = useCallback(async()=>{
  ...
  try {
    ...
    const {data}=await axios.get("https://personaltaskmanager-backend-9547.onrender.com/api/task/gp",{
            ...
            <div className='bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100'>
             ...
             <div className='space-y-2 sm:space-y-3'>
               <div className='flex items-center justify-between text-gray-700'>
                 ...
                 <span className='text-xs bg-purple-100 text-purple-700 px-1.5 py-0.5 sm:py-2
                 rounded-full'>
              ...
              <div className='bg-width rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100'>
