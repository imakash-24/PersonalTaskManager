...
const Profile = ({setCurrentUser, onLogout}) => {
    ...
    const savedProfile = async(e) => {
      ...
      try{
        ...
        toast.error(err.response?.data.message?.message || "Profile update failed")
      }
    }
    ...
    const changePassword = async (e)=>{
      ...
      try{
        ...
        toast.error(err.response?.data.message?.message || "Password update failed")
      }
    }
        ...
        <div className='flex items-center gap-4 mb-8'>  
         ...
         <div className='grid md:grid-cols-2 gap-8'>
            <section className={SECTION_WRAPPER}>
                ...
                {/* PERSONAL INFO */}
                <form onSubmit={savedProfile} className='space-y-4'>
