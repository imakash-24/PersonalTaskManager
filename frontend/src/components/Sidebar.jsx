 ...
 const renderMenuItems = (isMobile = false)=>(
  ...
  return (
   <>
          ...
          <div className='flex items-center gap-3'>
            ...
            <div>
              ...
              <p className='text-sm text-purple-500 font-medium flex items-center gap-1'>
                <Sparkles className="w-3 h-3"/> Let's crush some tasks!</p>
            </div>
          </div>
        </div>
            ...
            <div className={TIP_CARD.container}>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  ...
                  <p className={TIP_CARD.text}>Use keyboard shortcuts to boost your production!</p>
                </div>
              </div>
            </div>
          </div>
    ...
    {/* MOBILE DRAWER */}
    {mobileOpen && (
      <div className='fixed inset-0 x-40'>
