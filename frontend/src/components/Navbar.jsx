             ...
             {/* RIGHT SIDE */}
              <div className='flex items-center gap-4'>
                 ...
                 <div ref={menuref} className='relative'>
                    ...
                    {menuOpen && (
                      <ul className='absolute top-14 right-0 w-56 bg-white rounded-2xl shadow-xl border-purple-100 z-50 overflow-hidden
                       animate-fadeIn'>
                           <li className='p-2'>
                             <button onClick={()=>{
                              setMenuOpen(false)
                             ...
                             text-sm text-gray-700 transition-colors flex items-center gap-2 group' role="menuitem">
