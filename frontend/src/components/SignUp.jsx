...
import {Inputwrapper, MESSAGE_ERROR, MESSAGE_SUCCESS,FIELDS,BUTTONCLASSES } from "../assets/dummy"
...
const SignUp = ({onSwitchMode}) => {
  ...
  const handleSubmit = async(e)=>{
    ...
    try {
      ...
      setMessage({text:error.response?.data?.message || "An error accoured Please try again.", type:"error"})
    }
    finally{
      setLoading(false)
    }
