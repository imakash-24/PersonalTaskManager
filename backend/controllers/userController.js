...
const JWT_SECRET = process.env.JWT_SECRET || "9a17908d02e1f2580928dc3746ea4c78"
...
export async function updateProfile(req,res){
    ...
    {
      return res.status(400).json({success:false, message: "name and email field is required"}) 
    }
    try {
